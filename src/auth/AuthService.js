...
export default class AuthService {
  ...
  auth0 = new auth0.WebAuth({
    ...
    clientID: "8cazAckk2QyuWrL1iT2HqG4ExhbXLgkQ",
    redirectUri: "http://localhost:8080/login-test",
    audience: "https://airscan-auth-api",
  ...
  handleAuthentication() {
    ...
    this.auth0.parseHash((err, authResult) => {
      ...
      // router.replace("/login-test");
    });
  }

  // ... setSession, logout, isAuthenticated, getAuthToken, getUserProfile ...
